...
public class TicTacToe {
    ...
    static ArrayList <Integer> plyr2Pos = new ArrayList<>();
    	...
    	public static void main(String[] args) 
            {
                ...
                System.out.println("Enter your game symbol: ( x | o)");
                    plyr1 = supp.next();
                System.out.println("You are player "+"'"+plyr1+"'");

                System.out.println("Enter your game symbol: ( x | o)");
                    plyr2 = supp.next();
                while (plyr2.equals(plyr1))
                    {
                ...
                while (ext)
                    {
                        ...
                        /*while (extt)    trying to make another round
                            {
        ...
        public static void game_board(char[][] gBoard)
            {
